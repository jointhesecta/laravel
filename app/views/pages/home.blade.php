            ...
            <div class="panel-body bg-dark p-15">
                <div class="row m-b-6">
                    ...
                    <div class="col-xs-9">
                        ...
                        <h1 class="m-0 w-500">$<span class="animate-number" data-value="42567"
                                                     data-animation-duration="1400">0</span></h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <small class="stat-title">Last month</small>
                        <h3 class="m-0 w-500">$<span class="animate-number" data-value="38547"
                                                     data-animation-duration="1400">0</span></h3>
                    </div>
                    <div class="col-xs-6">
                        <small class="stat-title">Last week</small>
                        <h3 class="m-0 w-500">$<span class="animate-number" data-value="8754"
                                                     data-animation-duration="1400">0</span></h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8">
                        <div id="graph-wrapper">
                            <div class="graph-info p-r-10">
                                ...
                                <button href="#" id="bars" class="btn" disabled><span></span>
                                </button>
                                <button href="#" id="lines" class="btn active" disabled><span></span>
                                </button>
                            </div>
                            <div class="h-300">
                    ...
                    <div class="row" id="task-manager">
                        <div class="task-actions clearfix">
                            ...
                            <div class="pull-right">
                                <a href="#" class="create-task c-white p-r-10"><i class="fa fa-plus-circle"></i> Create
                                    Task</a>
                                <a href="#" class="delete-task c-white p-r-10"><i class="fa fa-minus-circle"></i> Delete
                                    All Tasks</a>
                            </div>
                        </div>
                        <ul id="sortable-todo">
                            <li class="sortable col-md-12 m-b-10 bd-3 bg-opacity-20 fade in">
                                <a href="#" class="pull-right c-white p-l-10" data-dismiss="alert"><i
                                        class="fa fa-times f-18"></i></a>
                                <a href="#" class="pull-right c-white" data-dismiss="alert"><i
                                        class="fa fa-pencil f-18"></i></a>
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="pull-right f-18 p-t-10">
                                        <i rel="tooltip" title="add to favs" data-placement="left"
                                           class="favs fa fa-star-o p-r-10"></i>
                                        <i rel="tooltip" title="send email" data-placement="left"
                                           class="fa fa-envelope-o p-r-10"></i>
                                        <i rel="tooltip" title="show phone" data-placement="left"
                                           class="fa fa-phone"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="#" class="message-item media">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="pull-right f-18 p-t-10">
                                        <i rel="tooltip" title="remove from favs" data-placement="left"
                                           class="favs fa fa-star p-r-10 c-orange"></i>
                                        <i rel="tooltip" title="send email" data-placement="left"
                                           class="fa fa-envelope-o p-r-10"></i>
                                        <i rel="tooltip" title="show phone" data-placement="left" title="show phone"
                                           class="fa fa-phone"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="pull-right f-18 p-t-10">
                                        ...
                                        <i rel="tooltip" title="send email" data-placement="left"
                                           class="fa fa-envelope-o p-r-10"></i>
                                        <i rel="tooltip" title="show address" data-placement="left"
                                           class="fa fa-home"></i>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="withScroll" data-height="480">
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar13_big.png" alt="avatar 13" width="50"
                                         class="pull-left">
                            ...
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar12_big.png" alt="avatar 12" width="50"
                                         class="pull-left">
                                ...
                                <p class="f-14 c-gray">Hello Steve, I have added new files in your Dropbox in order to
                                    show you how to...</p>
                            </a>
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar11_big.png" alt="avatar 11" width="50"
                                         class="pull-left">
                            ...
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar10_big.png" alt="avatar 10" width="50"
                                         class="pull-left">
                            ...
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar9_big.png" alt="avatar 9" width="50"
                                         class="pull-left">
                            ...
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar8_big.png" alt="avatar 8" width="50"
                                         class="pull-left">
                            ...
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <img src="assets/img/avatars/avatar7_big.png" alt="avatar 7" width="50"
                                         class="pull-left">
            ...
            <div class="col-md-4 p-0">
                <div class="widget bg-gray-l">
                    <div class="widget-body p-b-0">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h2 class="panel-title width-100p c-blue w-500 f-20 carrois" id="calender-current-day">
                                    Events Manager</h2>
...
<div class="row">
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" id="city-form"
               placeholder="Tape a name of a city (eg: New York, Chicago...)">
